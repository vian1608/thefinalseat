...
const passengerAdmin = text('src/modules/admin/admin.passenger.controller.mjs');
...
const m47 = text('migrations/047_stable_primary_passenger_sequence.sql');
...
assert.match(view, /passenger_sequence/);
assert.match(view, /is_primary/);
...
assert.match(passengerAdmin, /passenger_sequence: index \+ 1/);
assert.match(passengerAdmin, /is_primary: index === 0/);
assert.match(passengerAdmin, /order\('passenger_sequence'/);
...
assert.match(m47, /passenger_sequence/);
assert.match(m47, /is_primary/);
assert.match(m47, /trg_tfs_assign_traveller_sequence/);
assert.match(m47, /tfs_sync_traveller_change_stable/);
